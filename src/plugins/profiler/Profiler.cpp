	...
	RefPtr<ITransaction> transaction)
{
	constexpr const char* createSqlStaments[] = {
		...
		R"""(
		create view system.plg$prof_statement_stats_view
		as
		...
		R"""(
		create view system.plg$prof_psql_stats_view
		as
		...
		R"""(
		create view system.plg$prof_record_source_stats_view
		as
...
{
	// FIXME: call defineStatement2 in the engine
