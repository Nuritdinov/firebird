...
void CMP_post_access(thread_db* tdbb,
					 CompilerScratch* csb,
					 const QualifiedName& security_name,
 ...
 **************************************/
	...
	// FIXME: columnName argument vs relName parameter
 ...
 **************************************/
	...
	{
		QualifiedName packageName(procedure->getName().package, procedure->getName().schema);
