...
static const struct ini_idx_t indices[] =
{
	...
	INDEX(7, rel_classes, idx_unique, 2, ODS_13_0)
		SEGMENT(f_cls_schema, idx_metadata),	// schema name	// FIXME: maybe not good here, as lookup happens only with the name
	...
	INDEX(56, rel_pub_tables, idx_unique, 3, ODS_13_0)
		SEGMENT(f_pubtab_schema, idx_metadata),		// schema name
	...
	INDEX(58, rel_schemas, idx_unique, 1, ODS_13_2)
