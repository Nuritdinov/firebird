...
struct AccessItem
{
	QualifiedName	acc_security_name;
	...
	static bool greaterThan(const AccessItem& i1, const AccessItem& i2)
	{
		...
		*/
		...
		if ((v = i1.acc_security_name.schema.compare(i2.acc_security_name.schema)) != 0)
			return v > 0;

		if ((v = i1.acc_security_name.object.compare(i2.acc_security_name.object)) != 0)
			return v > 0;
	...
	AccessItem(const QualifiedName& security_name, SLONG view_id,
